...
@extends('navbar/nav-PengaturanAkun')
    <div class="container">
        <div class="form-container">
            <div class="header">
                <h2>Pengaturan Profil User 2</h2>
                <br>
                <img src="https://cdn-icons-png.flaticon.com/512/7641/7641828.png" alt="" class="profile-icon" width="40" height="40">
                <div class="profile-text">
                    <strong id="profile-username">{{ $datauser->firstWhere('role', 'user2')->username ?? 'OSIS' }}</strong>
                    <p>{{ $datauser->firstWhere('role', 'user2')->email ?? 'smkn1kawali@gmail.com' }}</p>
                </div>
            </div>
            <br>
            <hr>
