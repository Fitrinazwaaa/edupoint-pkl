        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                    <h5 class="navbar-nav flex-row" style="margin-left:-20%; list-style-type: none;">
                        ...
                        <li class="nav-item" style="margin-right: 20px;">
                            <a class="nav-link {{ request()->is('kesiswaan') ? 'active' : '' }}" href="{{ route('AkunKesiswaan') }}">KESISWAAN</a>
                        </li>
                        <li class="nav-item" style="margin-right: 20px;">
                            <a class="nav-link {{ request()->is('guru') ? 'active' : '' }}" href="{{ route('AkunGuru') }}">GURU</a> <!-- Tambah link guru -->
                        </li>
                        <li class="nav-item" style="margin-right: 20px;">
                            <a class="nav-link {{ request()->is('osis') ? 'active' : '' }}" href="{{ route('AkunOsis') }}">OSIS</a>
                        </li>
                </h5>
                </div>
            </div>
